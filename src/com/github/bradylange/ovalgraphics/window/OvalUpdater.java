...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------
	/**
	 * Adds the {@link #moveOneBtn}, {@link #moveAllBtn}, {@link #colorAllBtn}, and {@link #colorAllBtn}
	 * to the {@link #window}.
	 */
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------------
	/**
	 * Overrides the interface {@link ActionListener}'s method {@link #actionPerformed} to specify the actions 
	 * carried out when {@link #moveOneBtn}, {@link #moveAllBtn}, {@link #colorOneBtn}, or {@link #colorAllBtn} 
	 * is clicked. 
	 * 
